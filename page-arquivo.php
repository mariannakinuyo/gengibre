    ...
    <div class="container">
        <div class="row">
            <div class="col-12 mb-4">
                <h1 class="line-green"><?php echo get_cat_name( $category_id = 17 ); ?></h1>
            </div>
            <?php
            ...
            <div class="col-12 btn-arquivo">
                <a href="<?php echo $category_link; ?>"><button class="btn-primario">Leia mais</button></a>
            </div>
        </div>
    </div>
</section>
...
<section id="multimidia" class="my-5 bg-img bg-arquivo" style="background-image:url(<?php bloginfo('template_url'); ?>/src/images/quadro.png)">
    <div class="container">
        <div class="row">
            <div class="col-12 mb-4">
                <h1 class="line-green"><?php echo get_cat_name( $category_id = 18 ); ?></h1>
            </div>
            <?php
...
<section id="nossas-leituras" class="my-5">
    <div class="container">
        <div class="row">
            <div class="col-12 mb-4">
                <h1 class="line-green"><?php echo get_cat_name( $category_id = 19 ); ?></h1>
            </div>
            <?php
